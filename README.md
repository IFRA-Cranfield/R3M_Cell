  ...
  <ol>
    <li>
      ...
      <ul>
        ...
        <li><a href="#r3m-cell-repository">R3M-Cell Repository</a></li>
...
The R3M-Cell repository contains the Gazebo and MoveIt!2 packages for the robotic cells deployed at Cranfield University and AMRC-Sheffield as part of the R3M Project. These cells serve as a critical testbed for validating automation algorithms and assessing the integration of our ROS 2-based R3M Framework in simulation first and real-world manufacturing environments after.

This repository includes:

- Robot Specifications & CAD Models: 3D models and descriptions of the robotic systems.
- URDF (Unified Robot Description Format) Files: Essential for simulation and motion planning in ROS 2.
- Gazebo Simulation: A virtual representation of the manufacturing cells for testing and development.
- MoveIt!2 Integration: Enabling motion planning and control for robotic arms.
- Hardware Configuration: Information on the real robotic setup, ensuring consistency between simulation and physical implementation.

By consolidating these elements, R3M-Cell supports the development of automated, intelligent, and reconfigurable robotic systems that align with the core objectives of the R3M pPoject. This repository plays a crucial role in testing and refining the sim-to-real pipeline, which enables robots to autonomously interpret and execute manufacturing tasks with minimal human intervention.
