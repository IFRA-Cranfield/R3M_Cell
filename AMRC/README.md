...
More information about the R3M-Cell/AMRC robot cell configurations can be found in the r3mcell_amrc/config/configurations.yaml file. The following commands launch the Simulation/Sim+MoveIt!2/Bringup+MoveIt!2 ROS 2 Environments for the R3M Cells:
