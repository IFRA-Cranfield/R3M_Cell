...
def generate_launch_description():
    ...
    print("")
    print("===== ABB IRB-120: Robot Bringup (r3mcell_bringup) =====")
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("r3mcell_bringup"),
        "config",
    ...
    kinematics_yaml = load_yaml("r3mcell_moveit2", "config/kinematics.yaml")
    robot_description_kinematics = {"robot_description_kinematics": kinematics_yaml}

    # joint_limits.yaml file:
    joint_limits_yaml = load_yaml("r3mcell_moveit2", "config/joint_limits_bringup.yaml")
    ...
    pilz_cartesian_limits_yaml = load_yaml("r3mcell_moveit2", "config/pilz_cartesian_limits.yaml")
    ...
    ompl_planning_yaml = load_yaml("r3mcell_moveit2", "config/ompl_planning.yaml")
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # MoveIt!2 Controllers:
    moveit_simple_controllers_yaml = load_yaml(
        "r3mcell_bringup", "config/moveit_controllers.yaml"
    )
    moveit_controllers = {
